...
1) Algoritmo para jugar un sudoku 4*4 => modulos: logica, interfaz, control
2) Herramienta de calificaciones      => modulos: estudiante, materia, calculos, control
3) Algoritmo conversor de numeros     => modulos: decimal binario hexadecimal octal, control
